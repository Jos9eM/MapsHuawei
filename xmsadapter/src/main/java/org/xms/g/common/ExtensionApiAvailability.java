...
public class ExtensionApiAvailability extends org.xms.g.utils.XObject {
    ...
    public static org.xms.g.common.ExtensionApiAvailability getInstance() {
        if (org.xms.g.utils.GlobalEnvSetting.isHms()) {
            ...
            return ((hReturn) == null ? null : (new org.xms.g.common.ExtensionApiAvailability(null, hReturn)));
        } else {
            ...
            return ((gReturn) == null ? null : (new org.xms.g.common.ExtensionApiAvailability(gReturn, null)));
        }
    }
